...
import PaymentMethodsPanel from './components/PaymentsMethodsPanelP';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faBars } from '@fortawesome/free-solid-svg-icons';
import { faXmark } from '@fortawesome/free-solid-svg-icons';
import useOutsideClickHandler from 'hooks/useOutsideClickHandler';
import { useNavigate } from 'react-router-dom';
import BookingPanel from './components/BookingPanelP';
import Postajobp from './components/Postajobp';
import ProfileDetailsPanel from './components/ProfileDetailsPanelP';
