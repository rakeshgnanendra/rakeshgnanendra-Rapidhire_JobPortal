              ...
              {editIndex === index ? (
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-gray-500">
                   Company {method.cardNumber}
                  </p>
                  <p className="text-sm text-gray-500">
                   Minimum Experience {method.minexp}
                  </p>
                  <p className="text-sm text-gray-500">
                   Employment Type {method.emptype}
                  </p>
                  <p className="text-sm text-gray-500">
                    Location {method.expiryDate}
                  </p>
                </div>
              )}
...
export default PaymentMethodsPanelRes;
